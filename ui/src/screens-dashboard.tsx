			...
			<section className="welcome-panel">
				...
				<div className="welcome-content">
					<span className="welcome-kicker">
						<span className="sparkle">✦</span> Local-first quality loop
					</span>
					<h2>Get started with Tests</h2>
					<p>
						Turn every change into evidence with a test plan that learns your
						product, runs the important flows, and keeps the proof close.
					</p>
				...
				<div aria-hidden="true" className="welcome-orbit">
